...
// 触发「原著回忆/证据」模式的词。刻意不含「喜欢/抱着/亲吻/表白/睡在一起/睡一块」等当下亲密高频词：
// 这些在情侣日常对话里频繁出现，若当成原著查询信号，会把一句情话误劫持成「原著考据」，
// 进而落到 sourceRecallFallbackReply 的硬编码兜底（曾导致亲密语境冒出「对柱子…不能乱编」）。
// 真正的原著提问通常带专有名词（柱子/敏子/老鹰峡…）或回忆词（记得/原著/中考…），仍会命中。
// 「学校/北京/南京/见面」这类当下高频地点/动作词不进触发：用户随口「我还在学校呢」「我去北京」「改天见面」
// 会被劫持成原著考据 → 资料库 miss → 兜底「这段我不敢乱说」（2026-06-24 实测踩到）；
// 原著地点/学生时代剧情仍由专有名词（老鹰峡/湾子/西北）和「中考/考场/初遇/遇见」等更具体的词命中。
const SOURCE_RECALL_TRIGGER =
  /记得|还记得|想起|回忆|当年|以前|那时候|那会儿|原文|原著|小说|剧情|细节|第.{0,3}次|初遇|遇见|中考|考场|西北|湾子|老鹰峡|柱子|王玉柱|敏子|姚敏|小川|老赵|小刘|大刘|小彭|林慧珍|车祸|左臂|治疗|地质|研究所|救过|向导|小时候/;
